...
csv_file = "yash_time_synced_signals_with_frames.csv"

frame_ts = loadtxt('e:\\recording-car\\my_recording.csv', delimiter=',', skiprows=1)
print(frame_ts[:, 0].shape)

channels_ts = loadtxt('e:\\recording-car\\yash_gcar_signal_50Hz_outliers_zero_mean.csv', delimiter=',', skiprows=1)
