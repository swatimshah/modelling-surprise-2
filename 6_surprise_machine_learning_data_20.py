...
frame_eeg = loadtxt('E:\\recording-car\\yash_time_synced_signals_with_frames.csv', delimiter=',', skiprows=1)
...
savetxt("yash_total_epochs_20.csv", total_epochs, delimiter=",")
